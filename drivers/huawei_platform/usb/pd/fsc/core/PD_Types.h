...
#define tPSHardReset            28      * TICK_SCALE_TO_MS
...
#define tSrcRecover             730     * TICK_SCALE_TO_MS
...
typedef enum {
    ...
    FIRST_PE_ST = peDisabled,   // mark lowest value in enum /* Also 0 */
    ...
    FIRST_VDM_STATE = peUfpVdmGetIdentity, // Also 48
    peUfpVdmSendIdentity,		// Sending Discover Identity ACK

    peUfpVdmGetSvids,			// Requesting SVID info from DPM //50
    ...
    peUfpVdmAttentionRequest,	// Sending Attention Command  //60
    ...
    peDfpVdmModesRequest,		// Sending Discover Modes request  //70
    ...
    peSrcVdmIdentityNaked,		// inform DPM  //80
    ...
    peCblGetModesNak,			// Respond with NAK            //90
    ...
    PE_BIST_Frame_Received,     // Test Frame received by Protocol layer            //100
